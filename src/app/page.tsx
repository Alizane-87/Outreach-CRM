      ...
      <div className="max-w-[1900px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-6 gap-2.5 font-mono text-xs">
          ...
          >
            ...
            <div className="text-lg font-bold text-sky-300 mt-1">{stats.dm_sent}</div>
          </button>
          ...
          >
            ...
            <div className="text-lg font-bold text-amber-300 mt-1">{stats.follow_up}</div>
          </button>
          ...
          >
            ...
            <div className="text-lg font-bold text-indigo-300 mt-1">{stats.booked}</div>
          </button>
        </div>
